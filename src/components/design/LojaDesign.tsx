        ...
        <main style={{ flex: '1', minWidth: '0', display: 'flex', flexDirection: 'column' }}>
          <header style={{ position: 'sticky', top: '0', zIndex: '30', display: 'flex', alignItems: 'center', gap: '16px', minHeight: '78px', padding: '12px 30px', flexWrap: 'wrap', background: 'rgba(244,247,252,.88)', backdropFilter: 'blur(14px)', borderBottom: '1px solid #E6EAF2' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flex: '1', maxWidth: '460px', height: '46px', padding: '0 16px', background: '#FFFFFF', border: '1px solid #E6EAF2', borderRadius: '16px', boxShadow: '0 2px 8px rgba(11,18,32,.03)' }}>
              ...
              <input placeholder="Buscar página, banner ou cupom" style={{ flex: '1', border: '0', background: 'transparent', fontFamily: 'inherit', fontSize: '14px', color: '#0B1220' }} />
          ...
          <div style={{ padding: '26px 30px 60px', display: 'flex', flexDirection: 'column', gap: '20px', animation: 'riseIn .5s cubic-bezier(.2,.8,.2,1) both' }}>
            ...
            <div style={{ background: '#FFFFFF', border: '1px solid #E6EAF2', borderRadius: '24px', overflow: 'hidden' }}>
              ...
              <div style={{ overflowX: 'auto' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(130px,.9fr) minmax(200px,1.5fr) minmax(120px,.8fr) minmax(110px,.7fr) minmax(120px,.8fr) minmax(120px,.8fr)', gap: '14px', alignItems: 'center', padding: '14px 24px', borderBottom: '1px solid #F4F6FB', cursor: 'pointer' }} className="dc24">
                  <span style={{ fontSize: '13.5px', fontWeight: '700' }}>
                    FORMATURA25
                  </span>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(130px,.9fr) minmax(200px,1.5fr) minmax(120px,.8fr) minmax(110px,.7fr) minmax(120px,.8fr) minmax(120px,.8fr)', gap: '14px', alignItems: 'center', padding: '14px 24px', borderBottom: '1px solid #F4F6FB', cursor: 'pointer' }} className="dc25">
                  <span style={{ fontSize: '13.5px', fontWeight: '700' }}>
                    PRIMEIRACOMPRA
                  </span>
                  <span style={{ fontSize: '13.5px', color: '#34405A', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(130px,.9fr) minmax(200px,1.5fr) minmax(120px,.8fr) minmax(110px,.7fr) minmax(120px,.8fr) minmax(120px,.8fr)', gap: '14px', alignItems: 'center', padding: '14px 24px', borderBottom: '1px solid #F4F6FB', cursor: 'pointer' }} className="dc26">
                  <span style={{ fontSize: '13.5px', fontWeight: '700' }}>
                    FRETEGRATIS
                  </span>
                  <span style={{ fontSize: '13.5px', color: '#34405A', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(130px,.9fr) minmax(200px,1.5fr) minmax(120px,.8fr) minmax(110px,.7fr) minmax(120px,.8fr) minmax(120px,.8fr)', gap: '14px', alignItems: 'center', padding: '14px 24px', borderBottom: '1px solid #F4F6FB', cursor: 'pointer' }} className="dc27">
                  <span style={{ fontSize: '13.5px', fontWeight: '700' }}>
                    B2BOURO10
                  </span>
                  <span style={{ fontSize: '13.5px', color: '#34405A', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(130px,.9fr) minmax(200px,1.5fr) minmax(120px,.8fr) minmax(110px,.7fr) minmax(120px,.8fr) minmax(120px,.8fr)', gap: '14px', alignItems: 'center', padding: '14px 24px', borderBottom: '1px solid #F4F6FB', cursor: 'pointer' }} className="dc28">
                  <span style={{ fontSize: '13.5px', fontWeight: '700' }}>
                    NATAL24
                  </span>
                  <span style={{ fontSize: '13.5px', color: '#34405A', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
