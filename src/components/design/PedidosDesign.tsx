...
.dc17:hover { background: #F1F5FD; border-color: #D6E2FC; color: #2563EB; }
            ...
            <div style={{ padding: '26px 30px 60px', display: 'flex', flexDirection: 'column', gap: '20px', animation: 'riseIn .5s cubic-bezier(.2,.8,.2,1) both' }}>
              <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: '24px', flexWrap: 'wrap' }}>
                ...
                <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                  ...
                  <button style={{ whiteSpace: 'nowrap', height: '44px', padding: '0 18px', display: 'flex', alignItems: 'center', gap: '9px', border: '0', borderRadius: '14px', background: 'linear-gradient(135deg,#2563EB,#06B6D4)', color: '#FFFFFF', fontFamily: 'inherit', fontSize: '14px', fontWeight: '700', cursor: 'pointer', boxShadow: '0 8px 20px rgba(37,99,235,.28)' }} className="dc8">
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round">
                      <path d="M12 5v14M5 12h14" />
                    </svg>
                    Novo pedido
              ...
              <div style={{ background: '#FFFFFF', border: '1px solid #E6EAF2', borderRadius: '24px', overflow: 'hidden' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '16px', padding: '18px 24px', flexWrap: 'wrap' }}>
                  <div style={{ display: 'flex', gap: '4px', padding: '5px', background: '#F4F7FC', border: '1px solid #E6EAF2', borderRadius: '999px', flexWrap: 'wrap' }}>
                    <span onClick={v.setP0} style={css(v.per0)} className="dc14">
                      Todos
                    </span>
                    <span onClick={v.setP1} style={css(v.per1)} className="dc15">
                      Em produção
                    </span>
                    <span onClick={v.setP2} style={css(v.per2)} className="dc16">
                      Atrasados
                    </span>
                  </div>
                  <div style={{ display: 'flex', gap: '10px', alignItems: 'center', flexWrap: 'wrap' }}>
                    ...
                    <button style={{ whiteSpace: 'nowrap', height: '44px', padding: '0 18px', display: 'flex', alignItems: 'center', gap: '9px', border: '1px solid #E6EAF2', borderRadius: '14px', background: '#FFFFFF', color: '#0B1220', fontFamily: 'inherit', fontSize: '14px', fontWeight: '600', cursor: 'pointer' }} className="dc17">
                      <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div style={{ overflowX: 'auto' }}>
                  ...
                  {v.pedidos.map((pd: any, i7: number) => (
                    <div key={i7} onClick={pd.abrir} style={{ display: 'grid', gridTemplateColumns: '34px minmax(220px,1.6fr) minmax(150px,1.1fr) minmax(90px,.8fr) minmax(90px,.8fr) minmax(120px,1fr) minmax(120px,1fr) minmax(70px,.7fr)', gap: '14px', alignItems: 'center', padding: '14px 24px', borderBottom: '1px solid #F4F6FB', cursor: 'pointer' }} className="dc18">
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', minWidth: '0' }}>
                        ...
                        <div style={{ minWidth: '0' }}>
                          ...
                          <p style={{ margin: '2px 0 0', fontSize: '12px' }}>
                            <a href={pd.href} style={{ color: '#9AA7BC' }} className="dc19">
                              {pd.numero}
                            </a>
                          </p>
                        </div>
