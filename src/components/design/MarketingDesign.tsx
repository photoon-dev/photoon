// Gerado por tools/dc2tsx.py a partir de Marketing.dc.html
...
.dc24:hover { background: #F1F5FD; border-color: #D6E2FC; }
.dc25:hover { background: #F1F5FD; border-color: #D6E2FC; }
.dc26:hover { background: #F1F5FD; border-color: #D6E2FC; }
.dc27:hover { background: #F8FAFE; }
.dc28:hover { background: #F8FAFE; }
.dc29:hover { background: #F8FAFE; }
.dc30:hover { background: #F8FAFE; }
.dc31:hover { background: #F8FAFE; }
.dc32:hover { background: #F8FAFE; }
`;

export default function MarketingDesign({ v }: { v: any }) {
  return (
    <>
        ...
        <main style={{ flex: '1', minWidth: '0', display: 'flex', flexDirection: 'column' }}>
          <header style={{ position: 'sticky', top: '0', zIndex: '30', display: 'flex', alignItems: 'center', gap: '16px', minHeight: '78px', padding: '12px 30px', flexWrap: 'wrap', background: 'rgba(244,247,252,.88)', backdropFilter: 'blur(14px)', borderBottom: '1px solid #E6EAF2' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flex: '1', maxWidth: '460px', height: '46px', padding: '0 16px', background: '#FFFFFF', border: '1px solid #E6EAF2', borderRadius: '16px', boxShadow: '0 2px 8px rgba(11,18,32,.03)' }}>
              ...
              <input placeholder="Buscar campanha, público ou peça" style={{ flex: '1', border: '0', background: 'transparent', fontFamily: 'inherit', fontSize: '14px', color: '#0B1220' }} />
          ...
          <div style={{ padding: '26px 30px 60px', display: 'flex', flexDirection: 'column', gap: '20px', animation: 'riseIn .5s cubic-bezier(.2,.8,.2,1) both' }}>
            <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: '24px', flexWrap: 'wrap' }}>
              <div>
                ...
                <p style={{ margin: '0', fontSize: '14.5px', color: '#6B7A90' }}>
                  4 campanhas no ar · ROAS 4,2x · 1 842 leads captados no mês
                </p>
              </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px', alignItems: 'start' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                  <div>
                    ...
                    <div style={{ height: '8px', borderRadius: '999px', background: '#EEF1F7' }}>
                      <div style={{ width: '48%', height: '100%', borderRadius: '999px', background: 'linear-gradient(90deg,#2563EB,#06B6D4)' }}>
                      </div>
                    </div>
                  </div>
                  <div>
                    ...
                    <div style={{ height: '8px', borderRadius: '999px', background: '#EEF1F7' }}>
                      <div style={{ width: '34%', height: '100%', borderRadius: '999px', background: '#06B6D4' }}>
                      </div>
                    </div>
                  </div>
                  <div>
                    ...
                    <div style={{ height: '8px', borderRadius: '999px', background: '#EEF1F7' }}>
                      <div style={{ width: '12%', height: '100%', borderRadius: '999px', background: '#10B981' }}>
                      </div>
                    </div>
                  </div>
                  <div>
                    ...
                    <div style={{ height: '8px', borderRadius: '999px', background: '#EEF1F7' }}>
                      <div style={{ width: '6%', height: '100%', borderRadius: '999px', background: '#6366F1' }}>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div style={{ background: '#FFFFFF', border: '1px solid #E6EAF2', borderRadius: '24px', padding: '22px 26px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px', borderRadius: '16px', background: '#F8FAFE', border: '1px solid #EEF1F7', cursor: 'pointer' }} className="dc24">
                    <span style={{ width: '34px', height: '34px', borderRadius: '11px', background: '#EAF0FF', color: '#2563EB', display: 'flex', alignItems: 'center', justifyContent: 'center', flex: '0 0 auto' }}>
                      <svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M13 3 4.5 13.5H11l-1 7.5 8.5-10.5H12z" />
                      </svg>
                    ...
                    <div style={{ flex: '1', minWidth: '0' }}>
                      ...
                      <p style={{ margin: '2px 0 0', fontSize: '12px', color: '#6B7A90', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                        2 e-mails + WhatsApp · 22% recupera
                      </p>
                    </div>
                    <span style={{ whiteSpace: 'nowrap', padding: '6px 11px', borderRadius: '999px', background: '#E6F8F1', color: '#059669', fontSize: '12px', fontWeight: '600', width: 'max-content' }}>
                      ativo
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px', borderRadius: '16px', background: '#F8FAFE', border: '1px solid #EEF1F7', cursor: 'pointer' }} className="dc25">
                    <span style={{ width: '34px', height: '34px', borderRadius: '11px', background: '#E4F8FC', color: '#0891B2', display: 'flex', alignItems: 'center', justifyContent: 'center', flex: '0 0 auto' }}>
                      <svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <div style={{ flex: '1', minWidth: '0' }}>
                      <p style={{ margin: '0', fontSize: '13.5px', fontWeight: '600' }}>
                        Pós-entrega · avaliação
                      </p>
                      <p style={{ margin: '2px 0 0', fontSize: '12px', color: '#6B7A90', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                        envia 3 dias após entrega
                      </p>
                    </div>
                    <span style={{ whiteSpace: 'nowrap', padding: '6px 11px', borderRadius: '999px', background: '#E6F8F1', color: '#059669', fontSize: '12px', fontWeight: '600', width: 'max-content' }}>
                      ativo
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px', borderRadius: '16px', background: '#F8FAFE', border: '1px solid #EEF1F7', cursor: 'pointer' }} className="dc26">
                    <span style={{ width: '34px', height: '34px', borderRadius: '11px', background: '#EDEBFE', color: '#6366F1', display: 'flex', alignItems: 'center', justifyContent: 'center', flex: '0 0 auto' }}>
                      <svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
                        <rect x="2.5" y="5" width="19" height="14" rx="3.5" />
                        <path d="m3.5 7.5 8.5 6 8.5-6" />
            ...
            <div style={{ background: '#FFFFFF', border: '1px solid #E6EAF2', borderRadius: '24px', overflow: 'hidden' }}>
              ...
              <div style={{ overflowX: 'auto' }}>
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(190px,1.4fr) minmax(130px,.9fr) minmax(120px,.8fr) minmax(110px,.7fr) minmax(110px,.7fr) minmax(120px,.8fr)', gap: '14px', padding: '10px 24px', background: '#F8FAFE', borderTop: '1px solid #EEF1F7', borderBottom: '1px solid #EEF1F7', fontSize: '11.5px', letterSpacing: '.6px', textTransform: 'uppercase', color: '#9AA7BC', fontWeight: '700' }}>
                  <span>
                    Campanha
                  </span>
                  <span>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(190px,1.4fr) minmax(130px,.9fr) minmax(120px,.8fr) minmax(110px,.7fr) minmax(110px,.7fr) minmax(120px,.8fr)', gap: '14px', alignItems: 'center', padding: '14px 24px', borderBottom: '1px solid #F4F6FB', cursor: 'pointer' }} className="dc27">
                  <span style={{ fontSize: '13.5px', fontWeight: '700' }}>
                    Formatura 2026
                  </span>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(190px,1.4fr) minmax(130px,.9fr) minmax(120px,.8fr) minmax(110px,.7fr) minmax(110px,.7fr) minmax(120px,.8fr)', gap: '14px', alignItems: 'center', padding: '14px 24px', borderBottom: '1px solid #F4F6FB', cursor: 'pointer' }} className="dc28">
                  <span style={{ fontSize: '13.5px', fontWeight: '700' }}>
                    Fotolivro Dia das Mães
                  </span>
                  <span style={{ fontSize: '13.5px', color: '#34405A', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(190px,1.4fr) minmax(130px,.9fr) minmax(120px,.8fr) minmax(110px,.7fr) minmax(110px,.7fr) minmax(120px,.8fr)', gap: '14px', alignItems: 'center', padding: '14px 24px', borderBottom: '1px solid #F4F6FB', cursor: 'pointer' }} className="dc29">
                  <span style={{ fontSize: '13.5px', fontWeight: '700' }}>
                    Retargeting carrinho
                  </span>
                  <span style={{ fontSize: '13.5px', color: '#34405A', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(190px,1.4fr) minmax(130px,.9fr) minmax(120px,.8fr) minmax(110px,.7fr) minmax(110px,.7fr) minmax(120px,.8fr)', gap: '14px', alignItems: 'center', padding: '14px 24px', borderBottom: '1px solid #F4F6FB', cursor: 'pointer' }} className="dc30">
                  <span style={{ fontSize: '13.5px', fontWeight: '700' }}>
                    Reativação B2B
                  </span>
                  <span style={{ fontSize: '13.5px', color: '#34405A', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(190px,1.4fr) minmax(130px,.9fr) minmax(120px,.8fr) minmax(110px,.7fr) minmax(110px,.7fr) minmax(120px,.8fr)', gap: '14px', alignItems: 'center', padding: '14px 24px', borderBottom: '1px solid #F4F6FB', cursor: 'pointer' }} className="dc31">
                  <span style={{ fontSize: '13.5px', fontWeight: '700' }}>
                    Parceria influenciadores
                  </span>
                  <span style={{ fontSize: '13.5px', color: '#34405A', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                    Instagram
                  </span>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(190px,1.4fr) minmax(130px,.9fr) minmax(120px,.8fr) minmax(110px,.7fr) minmax(110px,.7fr) minmax(120px,.8fr)', gap: '14px', alignItems: 'center', padding: '14px 24px', borderBottom: '1px solid #F4F6FB', cursor: 'pointer' }} className="dc32">
                  <span style={{ fontSize: '13.5px', fontWeight: '700' }}>
                    Black Friday 2025
                  </span>
                  <span style={{ fontSize: '13.5px', color: '#34405A', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
