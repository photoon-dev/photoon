...
.dc27:hover { background: #F1F5FD; border-color: #D6E2FC; }
.dc28:hover { background: #F1F5FD; border-color: #D6E2FC; }
.dc29:hover { background: #F1F5FD; border-color: #D6E2FC; }
.dc30:hover { background: #F8FAFE; }
.dc31:hover { background: #F8FAFE; }
.dc32:hover { background: #F8FAFE; }
.dc33:hover { background: #F8FAFE; }
`;
        ...
        <main style={{ flex: '1', minWidth: '0', display: 'flex', flexDirection: 'column' }}>
          <header style={{ position: 'sticky', top: '0', zIndex: '30', display: 'flex', alignItems: 'center', gap: '16px', minHeight: '78px', padding: '12px 30px', flexWrap: 'wrap', background: 'rgba(244,247,252,.88)', backdropFilter: 'blur(14px)', borderBottom: '1px solid #E6EAF2' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flex: '1', maxWidth: '460px', height: '46px', padding: '0 16px', background: '#FFFFFF', border: '1px solid #E6EAF2', borderRadius: '16px', boxShadow: '0 2px 8px rgba(11,18,32,.03)' }}>
              ...
              <input placeholder="Buscar integração, chave ou webhook" style={{ flex: '1', border: '0', background: 'transparent', fontFamily: 'inherit', fontSize: '14px', color: '#0B1220' }} />
          ...
          <div style={{ padding: '26px 30px 60px', display: 'flex', flexDirection: 'column', gap: '20px', animation: 'riseIn .5s cubic-bezier(.2,.8,.2,1) both' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '20px', alignItems: 'start' }}>
              ...
              <div style={{ background: '#FFFFFF', border: '1px solid #E6EAF2', borderRadius: '24px', padding: '22px 26px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px', borderRadius: '16px', background: '#F8FAFE', border: '1px solid #EEF1F7', cursor: 'pointer' }} className="dc27">
                    <span style={{ width: '34px', height: '34px', borderRadius: '11px', background: '#E6F8F1', color: '#059669', display: 'flex', alignItems: 'center', justifyContent: 'center', flex: '0 0 auto' }}>
                      <svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M5 12.5 10 17.5 19 7" />
                      </svg>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px', borderRadius: '16px', background: '#F8FAFE', border: '1px solid #EEF1F7', cursor: 'pointer' }} className="dc28">
                    <span style={{ width: '34px', height: '34px', borderRadius: '11px', background: '#E6F8F1', color: '#059669', display: 'flex', alignItems: 'center', justifyContent: 'center', flex: '0 0 auto' }}>
                      <svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M5 12.5 10 17.5 19 7" />
                      </svg>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px', borderRadius: '16px', background: '#F8FAFE', border: '1px solid #EEF1F7', cursor: 'pointer' }} className="dc29">
            ...
            <div style={{ background: '#FFFFFF', border: '1px solid #E6EAF2', borderRadius: '24px', overflow: 'hidden' }}>
              ...
              <div style={{ overflowX: 'auto' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(170px,1.2fr) minmax(180px,1.3fr) minmax(150px,1fr) minmax(130px,.9fr) minmax(120px,.8fr) minmax(110px,.7fr)', gap: '14px', alignItems: 'center', padding: '14px 24px', borderBottom: '1px solid #F4F6FB', cursor: 'pointer' }} className="dc30">
                  <span style={{ fontSize: '13.5px', fontWeight: '700' }}>
                    pk_live_••••4412
                  </span>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(170px,1.2fr) minmax(180px,1.3fr) minmax(150px,1fr) minmax(130px,.9fr) minmax(120px,.8fr) minmax(110px,.7fr)', gap: '14px', alignItems: 'center', padding: '14px 24px', borderBottom: '1px solid #F4F6FB', cursor: 'pointer' }} className="dc31">
                  <span style={{ fontSize: '13.5px', fontWeight: '700' }}>
                    pk_live_••••8890
                  </span>
                  <span style={{ fontSize: '13.5px', color: '#34405A', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(170px,1.2fr) minmax(180px,1.3fr) minmax(150px,1fr) minmax(130px,.9fr) minmax(120px,.8fr) minmax(110px,.7fr)', gap: '14px', alignItems: 'center', padding: '14px 24px', borderBottom: '1px solid #F4F6FB', cursor: 'pointer' }} className="dc32">
                  <span style={{ fontSize: '13.5px', fontWeight: '700' }}>
                    pk_test_••••2210
                  </span>
                  <span style={{ fontSize: '13.5px', color: '#34405A', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(170px,1.2fr) minmax(180px,1.3fr) minmax(150px,1fr) minmax(130px,.9fr) minmax(120px,.8fr) minmax(110px,.7fr)', gap: '14px', alignItems: 'center', padding: '14px 24px', borderBottom: '1px solid #F4F6FB', cursor: 'pointer' }} className="dc33">
                  <span style={{ fontSize: '13.5px', fontWeight: '700' }}>
                    pk_live_••••1102
                  </span>
                  <span style={{ fontSize: '13.5px', color: '#34405A', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
