// Gerado por tools/dc2tsx.py a partir de Cliente Ajuda.dc.html
...
.dc16:hover { filter: brightness(1.06); color: #FFFFFF; }
...
export default function AjudaDesign({ v }: { v: any }) {
  return (
    <>
      <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#F4F7FC', fontFamily: '\'Plus Jakarta Sans\', sans-serif', color: '#0B1220' }}>
        ...
        <aside className="om-rail" style={css(v.railStyle)} onMouseEnter={v.openRail} onMouseLeave={v.closeRail}>
          ...
          <a href={v.hrefAjuda} title="Ajuda" style={{ display: 'flex', alignItems: 'center', gap: '14px', height: '48px', padding: '0 11px', borderRadius: '16px', flexShrink: '0', width: '100%', boxSizing: 'border-box', alignSelf: 'stretch', background: 'linear-gradient(135deg,#7C5CFF,#4F46E5)', color: '#FFFFFF', boxShadow: '0 8px 18px rgba(90,66,214,.28)' }} className="dc16">
            <svg viewBox="0 0 24 24" width="26" height="26" style={{ flexShrink: '0' }} fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
              <circle cx="12" cy="12" r="8.5" />
              <path d="M9.8 9.6a2.3 2.3 0 1 1 3 2.2v1.4M12 16.6h.01" />
            </svg>
        ...
        <main className="om-main" style={css(v.mainStyle)}>
          <div style={{ maxWidth: '1080px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '20px', animation: 'riseIn .5s cubic-bezier(.2,.8,.2,1) both' }}>
            ...
            <div style={{ background: '#FFFFFF', border: '1px solid #E6EAF2', borderRadius: '14px', padding: '24px 26px', display: 'flex', alignItems: 'center', gap: '22px', flexWrap: 'wrap' }}>
              <span style={{ width: '62px', height: '62px', borderRadius: '20px', background: 'linear-gradient(135deg,#2563EB,#06B6D4)', color: '#FFFFFF', display: 'flex', alignItems: 'center', justifyContent: 'center', flex: '0 0 auto' }}>
              ...
              <label style={{ position: 'relative', display: 'block', width: '300px', maxWidth: '100%', flex: '0 0 auto' }}>
                <span style={{ position: 'absolute', left: '15px', top: '50%', transform: 'translateY(-50%)', color: '#9AA7BC', display: 'flex' }}>
                  <svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
                    <circle cx="11" cy="11" r="6.5" />
                    <path d="m16 16 4 4" />
                  </svg>
                </span>
                <input value={v.busca} onChange={v.buscar} placeholder="Buscar na ajuda" style={{ width: '100%', height: '46px', padding: '0 14px 0 42px', border: '1px solid #E6EAF2', borderRadius: '12px', background: '#FFFFFF', fontFamily: 'inherit', fontSize: '14px', color: '#0B1220' }} />
              </label>
            </div>
            <div style={{ background: '#FFFFFF', border: '1px solid #E6EAF2', borderRadius: '14px', padding: '24px 26px' }}>
              <div style={{ marginBottom: '18px' }}>
                <p style={{ margin: '0', fontSize: '16.5px', fontWeight: '800', letterSpacing: '-.3px' }}>
                  Como funciona
                </p>
                <p style={{ margin: '4px 0 0', fontSize: '13px', color: '#9AA7BC' }}>
                  Da hora em que a loja libera as fotos até o álbum na sua mão.
                </p>
              </div>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '14px' }}>
                {v.passos.map((passo: any, i6: number) => (
                  <div key={i6} style={{ display: 'flex', flexDirection: 'column', gap: '10px', padding: '18px 20px', borderRadius: '16px', background: '#F8FAFE', border: '1px solid #EEF1F7' }}>
                    <span style={{ width: '34px', height: '34px', borderRadius: '12px', background: 'linear-gradient(135deg,#2563EB,#06B6D4)', color: '#FFFFFF', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '13.5px', fontWeight: '800', flex: '0 0 auto' }}>
                      {passo.n}
                    </span>
                    <p style={{ margin: '0', fontSize: '14px', fontWeight: '700' }}>
                      {passo.titulo}
                    </p>
                    <p style={{ margin: '0', fontSize: '12.5px', lineHeight: '1.6', color: '#6B7A90' }}>
                      {passo.texto}
                    </p>
                  </div>
                ))}
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '14px', flexWrap: 'wrap' }}>
              <p style={{ margin: '0', fontSize: '12px', letterSpacing: '1.6px', textTransform: 'uppercase', color: '#9AA7BC', fontWeight: '700' }}>
                Dúvidas frequentes
              </p>
              <p style={{ margin: '0', fontSize: '12.5px', color: '#9AA7BC' }}>
                {v.contagem}
              </p>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              {v.duvidas.map((duvida: any, i5: number) => (
                <div key={i5} style={css(duvida.cartao)}>
                  <button onClick={duvida.alternar} style={{ display: 'flex', alignItems: 'center', gap: '14px', width: '100%', padding: '17px 20px', border: '0', background: 'transparent', textAlign: 'left', fontFamily: 'inherit', cursor: 'pointer' }}>
                    <span style={{ flex: '1', minWidth: '0', fontSize: '14.5px', fontWeight: '600', color: '#0B1220' }}>
                      {duvida.pergunta}
                    </span>
                    <span style={css(duvida.seta)}>
                      <svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="m6 9 6 6 6-6" />
                      </svg>
                    </span>
                  </button>
                  <p style={css(duvida.respostaEstilo)}>
                    {duvida.resposta}
                  </p>
                </div>
              ))}
            ...
            <div style={{ border: '1px solid #E6EAF2', borderRadius: '14px', padding: '26px', background: 'linear-gradient(160deg,#F1F5FD,#E4F8FC)' }}>
              <p style={{ margin: '0', fontSize: '16.5px', fontWeight: '800', letterSpacing: '-.3px' }}>
                Não achou o que precisava?
              </p>
              <p style={{ margin: '6px 0 0', fontSize: '13.5px', lineHeight: '1.6', color: '#46536A', maxWidth: '560px' }}>
                {v.recado}
              </p>
              <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', marginTop: '18px' }}>
                ...
                <a href={v.hrefEmail} style={css(v.estiloEmail)}>
                  <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
                ...
                <a href={v.hrefWhatsapp} style={css(v.estiloWhatsapp)}>
                  <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M20 11.5a7.9 7.9 0 0 1-11.6 7L4 20l1.6-4.3A7.9 7.9 0 1 1 20 11.5z" />
                    <path d="M9.2 9.4c.3 1.9 2 3.9 4.1 4.6l1-1.2 1.7.7c-.2 1-1 1.5-2 1.4-2.8-.3-5.4-2.9-5.7-5.7-.1-1 .4-1.8 1.4-2l.7 1.7z" />
                  </svg>
                  Falar no WhatsApp
                </a>
              </div>
        ...
        <aside style={css(v.drawerStyle)}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '20px 22px', borderBottom: '1px solid #EEF1F7' }}>
            ...
            <button onClick={v.closeNotif} style={{ width: '38px', height: '38px', borderRadius: '12px', border: '1px solid #E6EAF2', background: '#FFFFFF', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#46536A', cursor: 'pointer', fontFamily: 'inherit' }} className="dc21">
          ...
          {Boolean(v.hasDetail) && (
            <>
              <div style={{ flex: '1', minHeight: '0', overflowY: 'auto', padding: '22px' }}>
                <button onClick={v.backToList} style={{ display: 'flex', alignItems: 'center', gap: '8px', height: '34px', padding: '0 12px', marginBottom: '18px', borderRadius: '10px', border: '1px solid #E6EAF2', background: '#FFFFFF', color: '#46536A', fontFamily: 'inherit', fontSize: '12.5px', fontWeight: '600', cursor: 'pointer' }} className="dc22">
                  <svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M19 12H6M12 5l-7 7 7 7" />
                  </svg>
