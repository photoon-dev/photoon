              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '24px', flexWrap: 'wrap' }}>
                <div>
                  ...
                  <p style={{ margin: '0', fontSize: '14.5px', color: '#6B7A90' }}>
                    Studio Fotográfico Lume · criado a 24 ago, 16:42 · prazo 27 ago
                  </p>
                </div>
              ...
              <div style={{ background: '#FFFFFF', border: '1px solid #E6EAF2', borderRadius: '24px', padding: '22px 26px' }}>
                <div style={{ display: 'flex', gap: '14px' }}>
                  <div style={{ flex: '1', display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    <div style={{ height: '6px', borderRadius: '999px', background: '#10B981' }}>
                    </div>
                    <div>
                      <p style={{ margin: '0', fontSize: '13.5px', fontWeight: '700', color: '#059669' }}>
                        Pagamento
                      </p>
                  ...
                  <div style={{ flex: '1', display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    <div style={{ height: '6px', borderRadius: '999px', background: 'linear-gradient(90deg,#2563EB,#06B6D4)' }}>
                    </div>
                    <div>
                      <p style={{ margin: '0', fontSize: '13.5px', fontWeight: '700', color: '#2563EB' }}>
                        Impressão
                      </p>
                      <p style={{ margin: '3px 0 0', fontSize: '12px', color: '#9AA7BC' }}>
                        Epson P9000 · 62%
                  ...
                  <div style={{ flex: '1', display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    ...
                    <div>
                      <p style={{ margin: '0', fontSize: '13.5px', fontWeight: '500', color: '#9AA7BC' }}>
                        Acabamento
                      </p>
                      <p style={{ margin: '3px 0 0', fontSize: '12px', color: '#9AA7BC' }}>
                        previsto 26 ago
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1.7fr 1fr', gap: '20px', alignItems: 'start' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                  <div style={{ background: '#FFFFFF', border: '1px solid #E6EAF2', borderRadius: '24px', overflow: 'hidden' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column' }}>
                      <div style={{ display: 'grid', gridTemplateColumns: '64px 1fr auto auto', gap: '16px', alignItems: 'center', padding: '16px 26px', borderTop: '1px solid #F4F6FB' }}>
                        <div style={{ width: '64px', height: '64px', borderRadius: '16px', overflow: 'hidden', background: '#F1F5FD' }}>
                          <span style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "100%", height: "100%", fontSize: "12px", color: "#9AA7BC" }}>Arte</span>
                        </div>
                        <div>
                          ...
                          <p style={{ margin: '3px 0 0', fontSize: '12.5px', color: '#6B7A90' }}>
                            Papel fine art 210g · laminação fosca · 48 páginas
                          </p>
                        </div>
                        <span style={{ fontSize: '13px', color: '#6B7A90' }}>
                          1 un
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: '64px 1fr auto auto', gap: '16px', alignItems: 'center', padding: '16px 26px', borderTop: '1px solid #F4F6FB' }}>
                        ...
                        <div>
                          <p style={{ margin: '0', fontSize: '14.5px', fontWeight: '600' }}>
                            Revelação 15×21 · 40 un
                          </p>
                          <p style={{ margin: '3px 0 0', fontSize: '12.5px', color: '#6B7A90' }}>
                            Brilho · borda branca 3 mm
                          </p>
                        </div>
                        <span style={{ fontSize: '13px', color: '#6B7A90' }}>
                          40 un
                      ...
                      <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '40px', padding: '18px 26px', background: '#F8FAFE', borderTop: '1px solid #EEF1F7' }}>
                  ...
                  <div style={{ background: '#FFFFFF', border: '1px solid #E6EAF2', borderRadius: '24px', padding: '22px 26px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(230px, 1fr))', gap: '12px' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '14px', borderRadius: '16px', background: '#F8FAFE', border: '1px solid #EEF1F7' }}>
                        <span style={{ width: '34px', height: '34px', borderRadius: '11px', background: '#E6F8F1', color: '#059669', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '14px', borderRadius: '16px', background: '#FEF3E2', border: '1px solid #FCE9CE' }}>
                        <span style={{ width: '34px', height: '34px', borderRadius: '11px', background: '#FFFFFF', color: '#B45309', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        ...
                        <div>
                          ...
                          <p style={{ margin: '2px 0 0', fontSize: '12px', color: '#6B7A90' }}>
                            2 avisos · pág. 12 e 31
                          </p>
                        </div>
                      </div>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '16px', padding: '14px 16px', borderRadius: '16px', background: '#F1F5FD' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="#2563EB" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
                          <path d="M14 3v5h5" />
                          <path d="M6 3h8l5 5v13H6z" />
                        </svg>
                        <div>
                          <p style={{ margin: '0', fontSize: '13.5px', fontWeight: '600' }}>
                            producao_PT-10482.pdf
                          </p>
                          <p style={{ margin: '2px 0 0', fontSize: '12px', color: '#6B7A90' }}>
                            1,8 GB · perfil FOGRA51 · gerado 25 ago 08:14
                          </p>
                        </div>
                      </div>
                  ...
                  <div style={{ background: '#FFFFFF', border: '1px solid #E6EAF2', borderRadius: '24px', padding: '22px 26px' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                      <div style={{ display: 'flex', gap: '14px' }}>
                        <span style={{ width: '10px', height: '10px', borderRadius: '999px', background: '#2563EB', marginTop: '5px', flex: '0 0 auto' }}>
                        </span>
                        <div>
                          <p style={{ margin: '0', fontSize: '13.5px', fontWeight: '600' }}>
                            Entrou em impressão · Epson P9000
                          </p>
                          <p style={{ margin: '2px 0 0', fontSize: '12.5px', color: '#9AA7BC' }}>
                            Hoje, 08:32 · João Pinto
                          </p>
                        </div>
                      </div>
                      <div style={{ display: 'flex', gap: '14px' }}>
                        <span style={{ width: '10px', height: '10px', borderRadius: '999px', background: '#06B6D4', marginTop: '5px', flex: '0 0 auto' }}>
                        </span>
                        <div>
                          <p style={{ margin: '0', fontSize: '13.5px', fontWeight: '600' }}>
                            Render concluído · 48 páginas
                          </p>
                          <p style={{ margin: '2px 0 0', fontSize: '12.5px', color: '#9AA7BC' }}>
                            25 ago, 08:14 · worker-03
                          </p>
                        </div>
                      </div>
                      <div style={{ display: 'flex', gap: '14px' }}>
                        <span style={{ width: '10px', height: '10px', borderRadius: '999px', background: '#10B981', marginTop: '5px', flex: '0 0 auto' }}>
                        </span>
                        <div>
                          <p style={{ margin: '0', fontSize: '13.5px', fontWeight: '600' }}>
                          ...
                          <p style={{ margin: '2px 0 0', fontSize: '12.5px', color: '#9AA7BC' }}>
                            24 ago, 16:45 · gateway
                          </p>
                        </div>
                      </div>
                      <div style={{ display: 'flex', gap: '14px' }}>
                        <span style={{ width: '10px', height: '10px', borderRadius: '999px', background: '#CBD5E6', marginTop: '5px', flex: '0 0 auto' }}>
                        </span>
                        <div>
                          <p style={{ margin: '0', fontSize: '13.5px', fontWeight: '600' }}>
                            Pedido criado na loja B2B
                          </p>
                          <p style={{ margin: '2px 0 0', fontSize: '12.5px', color: '#9AA7BC' }}>
                            24 ago, 16:42 · cliente
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                  ...
                  <div style={{ background: '#0B1220', borderRadius: '24px', padding: '22px 24px', color: '#FFFFFF', display: 'flex', alignItems: 'center', gap: '18px' }}>
                    <div style={{ width: '76px', height: '76px', borderRadius: '16px', background: '#FFFFFF', display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gridTemplateRows: 'repeat(5, 1fr)', gap: '2px', padding: '8px', flex: '0 0 auto' }}>
                    ...
                    <div>
                      ...
                      <a href="#" style={{ fontSize: '13px', fontWeight: '700', color: '#22D3EE' }}>
