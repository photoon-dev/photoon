...
.dc19:hover { background: #F1F5FD; color: #2563EB; }
        ...
        <main style={{ flex: '1', minWidth: '0', display: 'flex', flexDirection: 'column' }}>
          <header style={{ position: 'sticky', top: '0', zIndex: '30', display: 'flex', alignItems: 'center', gap: '16px', minHeight: '78px', padding: '12px 30px', flexWrap: 'wrap', background: 'rgba(244,247,252,.88)', backdropFilter: 'blur(14px)', borderBottom: '1px solid #E6EAF2' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flex: '1', maxWidth: '460px', height: '46px', padding: '0 16px', background: '#FFFFFF', border: '1px solid #E6EAF2', borderRadius: '16px', boxShadow: '0 2px 8px rgba(11,18,32,.03)' }}>
              ...
              <input placeholder="Buscar ticket, cliente ou artigo" style={{ flex: '1', border: '0', background: 'transparent', fontFamily: 'inherit', fontSize: '14px', color: '#0B1220' }} />
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '20px', alignItems: 'start' }}>
              <div style={{ background: '#FFFFFF', border: '1px solid #E6EAF2', borderRadius: '24px', overflow: 'hidden' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', padding: '10px' }}>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '7px', padding: '14px 16px', borderRadius: '16px', cursor: 'pointer', border: '1px solid #D6E2FC', background: '#F1F5FD' }} className="dc13">
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '7px', padding: '14px 16px', borderRadius: '16px', cursor: 'pointer', border: '1px solid transparent', background: 'transparent' }} className="dc14">
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '7px', padding: '14px 16px', borderRadius: '16px', cursor: 'pointer', border: '1px solid transparent', background: 'transparent' }} className="dc15">
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '7px', padding: '14px 16px', borderRadius: '16px', cursor: 'pointer', border: '1px solid transparent', background: 'transparent' }} className="dc16">
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '7px', padding: '14px 16px', borderRadius: '16px', cursor: 'pointer', border: '1px solid transparent', background: 'transparent' }} className="dc17">
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '7px', padding: '14px 16px', borderRadius: '16px', cursor: 'pointer', border: '1px solid transparent', background: 'transparent' }} className="dc18">
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              <div style={{ background: '#FFFFFF', border: '1px solid #E6EAF2', borderRadius: '24px', overflow: 'hidden', minWidth: '0', gridColumn: 'span 2' }}>
                <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '16px', padding: '20px 24px', borderBottom: '1px solid #F0F3F9', flexWrap: 'wrap' }}>
                  ...
                  <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                    <button style={{ whiteSpace: 'nowrap', height: '38px', padding: '0 14px', border: '1px solid #E6EAF2', borderRadius: '12px', background: '#FFFFFF', color: '#0B1220', fontFamily: 'inherit', fontSize: '13px', fontWeight: '600', cursor: 'pointer' }} className="dc19">
                      Abrir reimpressão
                    </button>
                    <button style={{ whiteSpace: 'nowrap', height: '38px', padding: '0 14px', border: '0', borderRadius: '12px', background: '#0B1220', color: '#FFFFFF', fontFamily: 'inherit', fontSize: '13px', fontWeight: '600', cursor: 'pointer' }} className="dc20">
                      Resolver ticket
                    </button>
                  </div>
                </div>
                ...
                <div style={{ padding: '16px 24px 20px', borderTop: '1px solid #F0F3F9' }}>
                  <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                    <span style={{ padding: '6px 12px', borderRadius: '999px', background: '#F4F7FC', border: '1px solid #E6EAF2', fontSize: '12px', fontWeight: '600', color: '#46536A', cursor: 'pointer' }} className="dc21">
                      Macro · reimpressão sem custo
                    </span>
                    <span style={{ padding: '6px 12px', borderRadius: '999px', background: '#F4F7FC', border: '1px solid #E6EAF2', fontSize: '12px', fontWeight: '600', color: '#46536A', cursor: 'pointer' }} className="dc22">
                      Macro · prazo de produção
                    </span>
                    <span style={{ padding: '6px 12px', borderRadius: '999px', background: '#F4F7FC', border: '1px solid #E6EAF2', fontSize: '12px', fontWeight: '600', color: '#46536A', cursor: 'pointer' }} className="dc23">
                  ...
                  <div style={{ border: '1px solid #E6EAF2', borderRadius: '18px', padding: '14px 16px' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '12px', flexWrap: 'wrap' }}>
                      <div style={{ display: 'flex', gap: '8px' }}>
                        <span style={{ width: '34px', height: '34px', borderRadius: '11px', border: '1px solid #E6EAF2', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#6B7A90', cursor: 'pointer' }} className="dc24">
                          <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
                            <path d="M8 12.5 14 6.5a3 3 0 0 1 4.2 4.2l-7.6 7.6a5 5 0 0 1-7-7L11 4.5" />
                          </svg>
                        </span>
                        <span style={{ width: '34px', height: '34px', borderRadius: '11px', border: '1px solid #E6EAF2', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#6B7A90', cursor: 'pointer' }} className="dc25">
                          <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
                            <path d="M14 3v5h5" />
                      ...
                      <div style={{ display: 'flex', gap: '8px' }}>
                        <button style={{ whiteSpace: 'nowrap', height: '38px', padding: '0 14px', border: '1px solid #E6EAF2', borderRadius: '12px', background: '#FFFFFF', color: '#46536A', fontFamily: 'inherit', fontSize: '13px', fontWeight: '600', cursor: 'pointer' }} className="dc26">
                          Nota interna
                        </button>
                        <button style={{ whiteSpace: 'nowrap', height: '38px', padding: '0 18px', border: '0', borderRadius: '12px', background: 'linear-gradient(135deg,#2563EB,#06B6D4)', color: '#FFFFFF', fontFamily: 'inherit', fontSize: '13px', fontWeight: '700', cursor: 'pointer' }} className="dc27">
                          Responder
                        </button>
                      </div>
                    </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                <div style={{ background: '#FFFFFF', border: '1px solid #E6EAF2', borderRadius: '24px', padding: '20px 22px' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    <a href="#" style={{ display: 'flex', alignItems: 'center', gap: '11px', padding: '11px 12px', borderRadius: '14px', background: '#F8FAFE', border: '1px solid #EEF1F7', color: '#34405A', fontSize: '13px', fontWeight: '600' }} className="dc28">
                    ...
                    <a href="#" style={{ display: 'flex', alignItems: 'center', gap: '11px', padding: '11px 12px', borderRadius: '14px', background: '#F8FAFE', border: '1px solid #EEF1F7', color: '#34405A', fontSize: '13px', fontWeight: '600' }} className="dc29">
                      <svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" style={{ flex: '0 0 auto' }}>
                        <path d="M4 5h7v15H4z" />
                        <path d="M13 5h7v15h-7z" />
                      </svg>
                    ...
                    <a href="#" style={{ display: 'flex', alignItems: 'center', gap: '11px', padding: '11px 12px', borderRadius: '14px', background: '#F8FAFE', border: '1px solid #EEF1F7', color: '#34405A', fontSize: '13px', fontWeight: '600' }} className="dc30">
                      <svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" style={{ flex: '0 0 auto' }}>
                        <path d="M4 5h7v15H4z" />
                        <path d="M13 5h7v15h-7z" />
                      </svg>
